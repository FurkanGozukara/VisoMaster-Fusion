...
Join the [SECourses Discord](https://discord.com/servers/software-engineering-courses-secourses-772774097734074388) for help, chat, and discussion. Tell me your Discord username to receive your special rank.

Please also star, watch, and fork the [Stable Diffusion & Generative AI repository](https://github.com/FurkanGozukara/Stable-Diffusion), join the [SECourses subreddit](https://www.reddit.com/r/SECourses/), and follow my [real LinkedIn profile](https://www.linkedin.com/in/furkangozukara/).

---

## Installation

- Follow this post slowly to learn the application's features and complete workflow.
- Latest installer ZIP for VisoMaster Fusion - [**VisoMaster_Fusion_v7.zip**](https://www.patreon.com/SECourses/posts/visomaster-and-0-121570322) (**recommended and most up to date**).
- [**Choose a membership and join to download the ZIP files**](https://www.patreon.com/cw/SECourses/membership).
- Alternative VisoMaster Fusion package from Maxieto - [**VisoMaster_Fusion_Maxieto_v2.zip**](https://www.patreon.com/SECourses/posts/visomaster-and-0-121570322) (**not recommended**; does not work on Linux or Massed Compute).
- Latest installer ZIP for original VisoMaster - [**VisoMaster_v10.zip**](https://www.patreon.com/SECourses/posts/visomaster-and-0-121570322) (**not recommended**).
- The installers automatically set up PyTorch 2.13, CUDA 13, the required precompiled libraries, TensorRT, and the required TensorRT engine assets.
...
- The SECourses applications are being upgraded to PyTorch 2.13 and CUDA 13.
- Precompiled wheels include all CUDA 13 features and CUDA architectures for `mslk`, `xformers`, `flash_attn`, `sageattention`, and `torchao`.
- These libraries are built with `abi3`, allowing them to work with Python 3.10, 3.11, 3.12, and 3.13.

<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/b2hugw6leTRlsP43XLt9u.png" alt="Precompiled CUDA 13 and PyTorch 2.13 wheel files supplied for the current VisoMaster Fusion installer update" width="3400" height="869" loading="lazy">
</figure>

- A newly developed advanced face-scan feature finds all faces and lets you select views that belong to the same person but were recognized as different identities by the models.
  - This was added in response to a user request.

<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/5SKp_gSvl_aAg8aVei-M2.png" alt="VisoMaster Fusion Scan Video menu with Smart Scan selected and its recommended sampling tooltip" width="741" height="375" loading="lazy">
</figure>

<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/HjVLTlD5yuE2uKKfR1Yec.png" alt="Review Scanned Faces window showing four unique face views ready for selection" width="844" height="342" loading="lazy">
</figure>

- The Play button now displays live processing FPS directly.

<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/5xrcpo58v1yi5CewQpFcL.png" alt="VisoMaster Fusion playback controls showing the live processing FPS readout beneath the play button" width="2105" height="1538" loading="lazy">
</figure>

## Windows Requirements

- The automatic installer requires Python 3.12.10 (Python 3.10.x, 3.11.x, and 3.13.x may also work), Git, FFmpeg, cuDNN 9.17 or newer, CUDA 13.0, and Visual Studio Community Edition with all C++ options installed.
- Alternatively, use `Windows_Start_Portable.bat`; it does not require any preinstalled requirements.
- Watch the [full requirements tutorial](https://youtu.be/DrhUHnYfwC0).
- See the [fully updated requirements post with screenshots and links](https://www.patreon.com/posts/111553210).

<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/O0vtccefxCKI1BVF7r-Bk.png" alt="Fusion v7 package files with Windows Install, Windows Start, portable start, and Massed Compute instructions highlighted" width="2480" height="1000" loading="lazy">
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/r2AF4U3pyl6c-T8wA9BK3.png" alt="VisoMaster Fusion Face Compare mode with original and processed face crops paired side by side for both detected actors" width="2560" height="1440" loading="eager">
</figure>
...
- [Why VisoMaster Fusion feels different](#why-visomaster-fusion-feels-different)
- [Installation and launcher maintenance](#installation)
- [Workspace tour](#the-workspace-at-a-glance)
- [First complete face swap](#your-first-complete-face-swap)
- [Media, faces, and embeddings](#media-faces-and-embeddings)
- [Swap models, strength, and likeness](#choosing-a-swap-model)
- [Masks, parsers, texture, color, and re-aging](#masks-the-difference-between-a-demo-and-a-believable-shot)
- [Restoration and expression systems](#two-stage-face-restoration)
- [Face Editor and denoiser](#face-editor-pose-expression-gaze-and-makeup)
- [Detection, tracking, timeline, presets, and jobs](#detection-landmarks-and-bytetrack)
- [Output, live workflows, VR180, and performance](#playback-recording-output-and-encoding)
- [Real demo cases and quality control](#real-demo-cases)
- [Troubleshooting and production recipe](#troubleshooting-by-symptom)
- [Complete 396-control reference](#complete-control-reference)
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/9Znc7uG2AErgUz8dgmVBU.png" alt="VisoMaster Fusion capabilities summarized by practical production use" width="2248" height="1225" loading="lazy">
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/27oHumEBEA2vEKji9TsQm.png" alt="The clean VisoMaster Fusion 3.6.1 main workspace in native 2560 by 1440 full-screen view" width="2560" height="1440" loading="lazy">
  <figcaption>The full workspace at native resolution. Panels can be hidden from the View menu when the viewer or parameters need more room.</figcaption>
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/LB8Ouqe1xr79QwW8S7pRi.png" alt="VisoMaster Fusion with the bundled target video selected and a source portrait loaded in Input Faces" width="2560" height="1440" loading="lazy">
  <figcaption>The reproducible starting point: bundled target footage in Target Media and a bundled portrait in Input Faces.</figcaption>
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/fvWK3WJdP8ZADE3pU62jJ.png" alt="The Scan Video mode menu and unique-face review workflow in VisoMaster Fusion" width="2560" height="1440" loading="lazy">
  <figcaption>Video scanning is review-first: choose sampling depth, inspect unique-face candidates, then add only the people the project needs.</figcaption>
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/KaOuV9cBoVXwXoKiwDcao.png" alt="A detected target face assigned to the bundled source identity with live swapping enabled" width="2560" height="1440" loading="lazy">
  <figcaption>Once a source is assigned, that target face owns its model, masks, restorers, expression treatment, and Face Editor state; global Denoiser and Settings controls remain shared.</figcaption>
</figure>
...
1. Detection and assignment.
2. Alignment and identity strength.
3. Occlusions and borders.
4. Eyes, mouth, tongue, and parser regions.
5. Restoration and expression.
6. Color, texture, denoising, and final enhancement.
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/CpTnKLPmjb5VY-OaPAbeS.png" alt="The Advanced Embedding Editor with reusable identity controls and source selections" width="2560" height="1440" loading="lazy">
  <figcaption>Embeddings turn a one-off source selection into a reusable identity asset; the editor handles combination, conversion, organization, and revision.</figcaption>
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/rEmfZcrlFEinv_anj1wRb.png" alt="VisoMaster Fusion swap-model choices and their practical roles" width="2582" height="795" loading="lazy">
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/Uc9wK7dDNmJIyE_CUgvZ7.png" alt="The VisoMaster Fusion Swapper section showing the model menu, resolution, interpolation, threshold, and sharpness controls" width="2560" height="1440" loading="lazy">
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/Chh0x4oxYeL1r7zbHmuXw.png" alt="Strength, anti-drift, face likeness, volumetric strength, and keypoint replacement controls" width="2560" height="1440" loading="lazy">
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/s2j2Htm7mrtlKYHSI9PFe.png" alt="Border, profile, occluder, XSeg, mouth-protection, obstacle-protection, and text mask controls" width="2560" height="1440" loading="lazy">
  <figcaption>The mask stack protects composition. Solve the narrowest problem first: border, profile, semantic obstacle, mouth sub-pass, then text guidance if needed.</figcaption>
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/qbGfH_5D_Nl6A_VkyyZjI.png" alt="Original Face Parser with mouth-fit, tongue, eye-restoration, and mouth-restoration controls expanded" width="2560" height="1440" loading="lazy">
  <figcaption>Mouth Fit, parser regions, and targeted eye, mouth, and tongue restoration recover only the areas that the swap actually damaged.</figcaption>
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/LugDrOZrWXTenPJAomv0Z.png" alt="Landmark-position correction, final blending, and face re-aging controls expanded in Face Swap" width="2560" height="1440" loading="lazy">
  <figcaption>Landmark correction, final blending, and optional re-aging provide precise late-stage control over geometry and age appearance.</figcaption>
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/Pe7c908h8plQCvOd8T-0B.png" alt="Face Restorer 1 and Face Restorer 2 with model, alignment, fidelity, blend, auto-restore, and pipeline-position controls" width="2560" height="1440" loading="lazy">
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/Gy0zHAZQMCo4X_v8H1vEL.png" alt="Simple Expression Restorer mode with factor, animation region, normalization, and pipeline-position controls" width="2560" height="1440" loading="lazy">
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/fVr0u1HXVNTC5tX9Tdkma.png" alt="Advanced expression controls showing eye, brow, lip, gaze-lock, coupled-eyelid, micro-expression, and Auto Mouth options" width="2560" height="1440" loading="lazy">
  <figcaption>Advanced mode separates expression systems and adds temporal gaze and mouth logic for shots that must survive motion, blinks, and speech.</figcaption>
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/46QmevYnlWr_Olp0sDz92.png" alt="Recast expression mode with enhancement and replacement, crop scale, animation region, driving weights, temporal smoothing, and paste-back feather" width="2560" height="1440" loading="lazy">
  <figcaption>Recast is a deliberate driving workflow, with independent crop, region, weight, smoothing, and paste-back controls.</figcaption>
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/IO4Esgtpt6HbGDXfbwA_B.png" alt="The Face Editor tab showing LivePortrait crop, pose, expression, gaze, and makeup controls" width="2560" height="1440" loading="lazy">
  <figcaption>The Face Editor can reshape performance and styling after identity assignment without leaving the VisoMaster workspace.</figcaption>
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/oMiLwfwES3yP69CmUsosM.png" alt="The global ReF-LDM Denoiser with Exclusive Reference Path toggle, base seed, three pass positions, Single Step, and DDIM controls" width="2560" height="1440" loading="lazy">
  <figcaption>The global denoiser is reproducible when its assigned reference K/V map and seed stay fixed. Place it where the pipeline needs cleanup, not everywhere at once.</figcaption>
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/0W3SMKhMSa-MrADpzT5su.png" alt="A live frame with face detection boxes and landmarks plus detector, landmark, smoothing, and ByteTrack settings" width="2560" height="1440" loading="lazy">
  <figcaption>Diagnostic overlays turn detection, alignment, and tracking into visible evidence. Disable them before final output.</figcaption>
</figure>
...
| `C` / `V` | Step one frame backward / forward |
| `A` / `D` | Jump by the configured skip amount |
| `Z` | Go to the beginning |
| `F` | Add a marker |
| `Alt+F` | Remove the current marker |
| `Q` / `W` | Previous / next marker |
| `X` | Toggle Face Compare |
| `T` | Toggle Theatre mode |
| `Ctrl+0` / `Ctrl+1` | Fit view / 100% view |
| `F11` | Full screen |
| `Esc` | Leave Theatre mode or full screen |
| Mouse wheel over viewer | Zoom the viewer |

<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/jjUCJEdzLR89h346m5ixl.png" alt="VisoMaster Fusion keyboard shortcuts for playback, swapping, recording, navigation, markers, compare, theatre, and viewer control" width="746" height="1276" loading="lazy">
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/VK7s6kdSqnggl7fSuFytm.png" alt="The VisoMaster Fusion timeline with settings markers, record ranges, transport controls, and Scan Tools menu" width="2560" height="1440" loading="lazy">
  <figcaption>Markers make per-face and global settings time-aware; Issue Scan flags target-identity matching failures inside eligible ranges before a long render.</figcaption>
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/IWp_hgDs0CGJ852vBWtKY.png" alt="Three real tutorial presets listed in the VisoMaster Presets panel" width="2560" height="1440" loading="lazy">
  <figcaption>The Presets panel stores reusable looks; Apply Settings decides whether global Denoiser and Settings values travel with the selected face parameters.</figcaption>
</figure>
...
1. Finish and preview one representative frame.
2. Inspect a profile, expression extreme, occlusion, and lighting change.
3. Add settings markers if one static pipeline is insufficient.
4. Confirm output destination, SDR/HDR path, encoder preset, quality/AQ, FPS limit, and source-audio expectations.
5. Save the workspace as a clearly named job.
6. Load the job once to prove its paths and assignments survived.
7. Queue the remaining targets, then process selected jobs before committing the entire list.

<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/phkywgr5UWMUMke3E0C5s.png" alt="The Job Manager populated with saved VisoMaster projects ready for selected or unattended batch processing" width="2560" height="1440" loading="lazy">
  <figcaption>Jobs turn a configured workspace into a queueable unit and validate missing inputs before unattended processing.</figcaption>
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/Wk-vuyxaUx-AiC--1Abi7.png" alt="Provider, playback, recording, output, and performance settings in VisoMaster Fusion" width="2560" height="1440" loading="lazy">
  <figcaption>Global Settings determine how the application executes, previews, records, and organizes the per-face pipelines built elsewhere.</figcaption>
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/pPd4zir349IJYi5Dha8Oh.png" alt="Frame enhancer, webcam, virtual camera, and VR180 controls in the Settings panel" width="2560" height="1440" loading="lazy">
  <figcaption>Enhancement and live/immersive modes share the workspace but have different quality checks: texture for upscaling, latency for webcam, and geometry for VR180.</figcaption>
</figure>
...
1. Prove the project with CUDA.
2. Choose a realistic input-resize ceiling.
3. Keep only repeatedly used models resident.
4. Measure a representative segment, not an easy still.
5. Try TensorRT only after the CUDA result is correct.
6. Compare output pixels as well as frames per second.
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/Gl1QeiUpB2wHw5Lmfbk1n.png" alt="Current VisoMaster Fusion CUDA versus TensorRT benchmark report with measured throughput and environment details" width="2560" height="1440" loading="lazy">
  <figcaption>The benchmark shown here was rerun on the audited 3.6.1 installation; exact figures belong to this hardware, driver, models, footage, and configuration.</figcaption>
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/wEVkzWIR1RGqrkvCo5rzE.png" alt="A labeled grid comparing the original bundled frame, baseline face swap, mask and restoration refinement, and advanced expression result" width="2560" height="1440" loading="lazy">
</figure>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/6345bd89fe134dfd7a0dba40/JNIHruHALUN3Cz9k-k8rN.png" alt="The finished bundled demo playing in VisoMaster Fusion Theatre mode at full screen" width="2560" height="1440" loading="lazy">
</figure>
...
1. **Ingest:** organize targets, sources, and output roots; decide whether folder recursion is safe.
2. **Identify:** scan footage, review candidates, create or select embeddings, and assign every relevant person.
3. **Baseline:** choose the swap model and alignment; prove identity with all optional finishing disabled.
4. **Composite:** solve borders, profiles, obstacles, mouth, eyes, and parser regions.
5. **Perform:** add expression, gaze, or Face Editor changes only where the shot needs them.
6. **Finish:** restore, denoise, texture-match, color-match, and enhance in restrained stages.
7. **Temporal QA:** inspect representative motion and run issue scans where supported.
8. **Encode test:** render a short range with the final FPS limit, SDR/HDR path, preset, quality/AQ, and source audio.
9. **Package:** save a preset for the look, a workspace for the project, and a job for the queue.
10. **Render and review:** process selected jobs first, then inspect the encoded deliverable in its destination environment.
...
## Main-window action reference

| Area | Actions and use |
|---|---|
| File | Load target folders/files and input-face folders/files; open the current target, input, or output folder; Load/Save/Save As Workspace; and Load/Save/Save As Embeddings |
| Workspace lifecycle | A clean exit writes `last_workspace.json` and normally prompts on the next launch; Auto Load Last Workspace skips the prompt, while Auto Save Workspace separately saves to the output folder after recording |
| Edit | Copy Parameters from Selected Face, Paste Parameters to Selected Face, or Reset Selected Face Parameters |
| Parameter scope | Face Swap, Restorers/Expressions, and Face Editor are per target face; Denoiser and Settings are global |
| Target Media | Add file or folder, drag and drop, search, filter Images/Videos/Webcams, change thumbnails, open/remove/clear, and optionally recurse through subfolders |
| Input Faces | Add file or folder, drag and drop, search, create embeddings, open/remove/delete source files, change thumbnails, clear, and optionally recurse through subfolders |
| Find Faces | Detect identities on the current image or video frame and create target-face cards |
| Scan Video | Quick, Smart, or Every Frame unique-face discovery; review candidates, select only wanted identities, add selected, and jump to source frames |
| Target-face card | Assign one source by click, build multi-source assignments with Ctrl-click or ranges with Shift-click, Copy/Paste Parameters, Save Parameters and Settings, Load Parameters, Load Parameters and Settings, inspect source frame, change thumbnail, or remove |
| Embeddings | Create Mean/Median identities, use optional K/V maps, load in the Advanced Embedding Editor, combine, convert, rename, sort, copy/paste, delete, undo, and redo |
| Viewer | Fit, 100% zoom, mouse-wheel zoom, middle-drag pan, full screen, Theatre mode, Face Compare, swap/difference/texture mask views, right-click actions, and Save Image; `Esc` leaves Theatre/full screen |
| Transport | Play/pause, one-frame and configured-step seeking, seek to start, loop, buffering, preview-only custom FPS, Processing FPS readout, live audio volume, and preview audio delay |
| Timeline markers | Snapshot both per-face parameters and global controls, navigate previous/next, remove, and define Record Start/End segments; Track Markers on Video Seek loads the applicable state during manual seeks |
| Scan Tools | Scan eligible ranges for configured target identities that cannot be matched, navigate issues, drop/restore current or issue frames, clear issues, and restore dropped frames; this is not an aesthetic-quality detector |
| Presets | Save and apply reusable face parameters with Apply or a confirmed double-click; Apply Settings also carries global Denoiser/Settings values; right-click renames or sends a deleted preset to the recycle bin |
| Output | Choose a destination; use Output to Target Location, Preserve Source Directory Structure, or Cluster Output by Source Name; save PNG by default or enable Save Output Image in JPG Format |
| Video recording | Direct output is auto-named; SDR uses 10-bit HEVC NVENC and HDR uses 10-bit CPU libx265. FFMpeg options exposes preset, quality, auto-quality, and AQ controls. Source audio is muxed automatically when possible |
| Direct batch | Batch Process Selected Face handles images and videos with the current configuration and markers; Batch Process All Faces detects and processes every face in images only |
| Job Manager | Save/load/delete/refresh jobs, process all or selected, validate source paths, and move completed jobs to `jobs/completed` |
| View | Fit or 100% view; show/hide Target, Input, Job Manager, Faces/Embeddings, and Parameters; enter full screen or Theatre mode; choose Face Compare or the three mask-debug views |
| GPU memory | Read the live VRAM meter, keep frequently used models loaded, or unload them explicitly with Clear VRAM |
| Help | Open Quick Start Guide, User Manual, View Shortcuts, the Presets explainer, or About |
| Launcher maintenance | Update, repair, check dependencies/models, optimize or restore models, self-update, and roll back where available. Repair backs up tracked edits; branch changes and rollback can replace them |

> **Mobile reading:** the complete reference tables are intentionally wide. Swipe horizontally inside a table to reveal every column; the rest of the page remains fixed to the screen width.

<!-- COMPLETE_CONTROL_REFERENCE -->
